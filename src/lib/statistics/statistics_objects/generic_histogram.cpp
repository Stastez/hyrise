...
std::shared_ptr<GenericHistogram<T>> GenericHistogram<T>::with_single_bin(const T& min, const T& max,
                                                                          ...
                                                                          const HistogramDomain<T>& domain) {
  return std::make_shared<GenericHistogram>(std::vector<T>{{min}}, std::vector<T>{{max}},
                                            std::vector<HistogramCountType>{height},
                                            std::vector<HistogramCountType>{distinct_count}, domain);
}
