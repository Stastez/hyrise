 ...
 public:
  void SetUp() override {
    ...
    const auto histogram_c_x = std::make_shared<EqualDistinctCountHistogram<int32_t>>(
        pmr_vector<int32_t>{0, 8}, pmr_vector<int32_t>{7, 15}, pmr_vector<HistogramCountType>{32, 32}, 8, 0);

    const auto histogram_c_y = std::make_shared<GenericHistogram<int32_t>>(
        pmr_vector<int32_t>{0}, pmr_vector<int32_t>{9}, pmr_vector<HistogramCountType>{64},
