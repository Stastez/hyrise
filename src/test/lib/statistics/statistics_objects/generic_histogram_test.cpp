...
TEST_F(GenericHistogramTest, SplitAtBinBounds) {
  ...
  const auto expected_heights = std::vector<HistogramCountType>{14.4, 9.6, 16.0, 6.0 / 21.0 * 30.0, 30.0 - 6.0 / 21.0 * 30.0, 20.0, 10};
  const auto expected_distinct_counts = std::vector<HistogramCountType>{3.6, 2.4, 4.0, 6.0 / 21.0 * 20.0, 20.0 - 6.0 / 21.0 * 20.0, 15, 5};
