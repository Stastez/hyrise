...
TEST_F(GenericHistogramTest, PrunedInt) {
...

  {
    ...
    const auto expected_histogram = GenericHistogram<int32_t>{
      pmr_vector<int32_t>            { 1, 31, 60, 80},
      pmr_vector<int32_t>            {25, 50, 60, 99},
      pmr_vector<HistogramCountType> {40, 30, 5.0 * remaining_ratio, 10.0 * remaining_ratio},
      pmr_vector<HistogramCountType> {10, 20, 1,  1}};
    // clang-format on
...

  {
    ...
    const auto expected_histogram = GenericHistogram<int32_t>{
      pmr_vector<int32_t>            { 1, 31, 60, 80},
      pmr_vector<int32_t>            {25, 50, 60, 99},
      pmr_vector<HistogramCountType> {28, 20, 5*2.0/3,  10*2.0/3},
      pmr_vector<HistogramCountType> {10, 20, 1,  1}};
    // clang-format on
...
TEST_F(GenericHistogramTest, SplitAtBinBounds) {
  ...
  const auto expected_heights = pmr_vector<HistogramCountType>{14.4, 9.6, 16.0, 6.0 / 21.0 * 30.0, 30.0 - 6.0 / 21.0 * 30.0, 20.0, 10};
  const auto expected_distinct_counts = pmr_vector<HistogramCountType>{3.6, 2.4, 4.0, 6.0 / 21.0 * 20.0, 20.0 - 6.0 / 21.0 * 20.0, 15, 5};
